...
Разрабатываю аналитические веб-приложения: интерактивные карты, дашборды и интерфейсы для работы с большими объёмами данных. Более 3 лет коммерческого опыта. Сейчас — ведущий программист в Институте Генплана Москвы.
...
- **ГБУ «ГлавАПУ»** — Frontend Engineer, ноябрь 2023 — март 2026.
